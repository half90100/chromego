...
//ads/devrel/adwords/shimesu/bg.js
goog.loadModule(function(exports) {'use strict';goog.module('ads.devrel.adwords.shimesu.bg');

/**
 * Initialization process to add an event listener that checks if the URL is
  ...
  chrome.runtime.onInstalled.addListener(() => {
    ...
    chrome.declarativeContent.onPageChanged.removeRules(undefined, () => {
      ...
      chrome.declarativeContent.onPageChanged.addRules([{
        // That fires when a page's URL equals to "adwords.google.com" or
        // "ads.google.com".
        conditions: [
          ...
          new chrome.declarativeContent.PageStateMatcher(
              {pageUrl: {hostEquals: 'ads.google.com', pathPrefix: '/aw/'}})
        ],
