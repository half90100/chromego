...
//ads/devrel/adwords/shimesu/resources.js
goog.loadModule(function(exports) {'use strict';/**
 * @fileoverview This file contains a resource category enum, {@link Resource}
 * that contains info about the web pages of AdWords API and Google Ads API, and
 * {@link ResourcesForProducts} that holds arrays of related resources for
 * AdWords API and Google Ads API.
 *
 * It also contains a mapping from AdWords new experience URL paths to their
 * relevant resources for both AdWords API and Google Ads API.
 */

goog.module('ads.devrel.adwords.shimesu.resources');
...
const ResourceCategory = {
  /**
   * This is a guide explaining how to use AdWords API / Google Ads API
   * features.
   */
  GUIDE: 'guide',
  /** This is a reference page of a service of AdWords API / Google Ads API. */
  SERVICE: 'service',
  /** This is a report reference page, available only for AdWords API. */
  REPORT: 'report',
  /** This is a field reference page, available only for Google Ads API. */
  FIELD: 'field',
  /**
   * This is a Google Ads API page that is stored at the root directory
   * (outside the "docs/" directory).
   */
  GAAPI_ROOT: 'gaapi-root'
};

/**
 * Contains information about a resource, including its name, URL path, and its
 * category. See {@link ResourceCategory} for a valid category name.
 * @record
 */
class Resource {
  constructor() {
    /** @type {string} name The name of this resource. */
    this.name;
    /** @type {string} urlPath The URL path of this resource. */
    this.urlPath;
    /** @type {!ResourceCategory} category The category of this resource. */
    this.category;
  }
}

/**
 * Contains the related resources for AdWords API and Google Ads API.
 * @record
 */
class ResourcesForProducts {
  constructor() {
    /** @type {!Array<!Resource>} awapiResources The AdWords API resources. */
    this.awapiResources;
    /**
     * @type {!Array<!Resource>} gaapiResources The Google Ads API resources.
     */
    this.gaapiResources;
  }
}

// Pre-defined resources with URLs.

// AdWords API guides.
const /** !Resource */ accountsOverviewGuide = {
  name: 'Managing Accounts',
  urlPath: '/guides/accounts-overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ adCustomizersGuide = {
  name: 'Customizing Text Ads',
  urlPath: '/guides/ad-customizers',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ adFeaturesGuide = {
  name: 'Ads Overview',
  urlPath: '/guides/ad-features',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ analyticsGuide = {
  name: 'Integrating Google Analytics',
  urlPath: '/guides/analytics',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ authenticationGuide = {
  name: 'OAuth2 Authentication',
  urlPath: '/guides/authentication',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ awqlGuide = {
  name: 'The AdWords Query Language (AWQL)',
  urlPath: '/guides/awql',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ bestpracticesGuide = {
  name: 'Best Practices',
  urlPath: '/guides/bestpractices',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ bidLandscapesGuide = {
  name: 'Bid Landscapes',
  urlPath: '/guides/bid-landscapes',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ biddingGuide = {
  name: 'Bidding',
  urlPath: '/guides/bidding',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ budgetOrderGuide = {
  name: 'Budget Order Service',
  urlPath: '/guides/budget-order',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ budgetsGuide = {
  name: 'Campaign Budgets',
  urlPath: '/guides/budgets',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ callStructureGuide = {
  name: 'API Call Structure',
  urlPath: '/guides/call-structure',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ campaignDraftsExperimentsGuide = {
  name: 'Campaign Drafts and Experiments',
  urlPath: '/guides/campaign-drafts-experiments',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ campaignGroupsGuide = {
  name: 'Campaign Groups and Performance Targets',
  urlPath: '/guides/campaign-groups',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ campaignsOverviewGuide = {
  name: 'Campaigns Overview',
  urlPath: '/guides/campaigns-overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ clickTrackingGuide = {
  name: 'Click Tracking in AdWords',
  urlPath: '/guides/click-tracking',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ conversionTrackingGuide = {
  name: 'Tracking and Importing Conversions',
  urlPath: '/guides/conversion-tracking',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ dynamicRemarketingGuide = {
  name: 'Dynamic Remarketing',
  urlPath: '/guides/dynamic-remarketing',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ dynamicSearchAdsGuide = {
  name: 'Dynamic Search Ads',
  urlPath: '/guides/dynamic-search-ads',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ entityRelationshipsGuide = {
  name: 'Entity Relationships',
  urlPath: '/guides/entity-relationships',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ exemptionRequestsGuide = {
  name: 'Policy Exemption Requests',
  urlPath: '/guides/exemption-requests',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ expandedTextAdsGuide = {
  name: 'Expanded Text Ads',
  urlPath: '/guides/expanded-text-ads',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ extensionSettingsGuide = {
  name: 'Extension Setting Services',
  urlPath: '/guides/extension-settings',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ feedMatchingFunctionsGuide = {
  name: 'Matching Functions',
  urlPath: '/guides/feed-matching-functions',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ feedServicesLocationsGuide = {
  name: 'Location Extensions',
  urlPath: '/guides/feed-services-locations',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ feedServicesGuide = {
  name: 'Introduction to Feeds Services',
  urlPath: '/guides/feed-services',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ firstApiCallGuide = {
  name: 'Make Your First API Call',
  urlPath: '/guides/first-api-call',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ geotargetingGuide = {
  name: 'Geotargets',
  urlPath: '/appendix/geotargeting',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ keywordPlanningReleaseNotes = {
  name: 'Keyword Planning Release Notes',
  urlPath: '/release-notes#keyword_planning',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ labelsGuide = {
  name: 'Labels',
  urlPath: '/guides/labels',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ locationTargetingGuide = {
  name: 'Location Targeting',
  urlPath: '/guides/location-targeting',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ mobileAppCampaignsGuide = {
  name: 'Mobile App Campaigns',
  urlPath: '/guides/mobile-app-campaigns',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ negativeKeywordsSharedSetsGuide = {
  name: 'Negative Keywords, Placements, and Shared Sets',
  urlPath: '/guides/negative-keywords-shared-sets',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ objectsMethodsGuide = {
  name: 'Objects, Methods, and Services',
  urlPath: '/guides/objects-methods',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ partialFailureGuide = {
  name: 'Partial Failure',
  urlPath: '/guides/partial-failure',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ rateLimitsGuide = {
  name: 'Rate Limits',
  urlPath: '/guides/rate-limits',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ remarketingGuide = {
  name: 'Remarketing and Audience Targeting',
  urlPath: '/guides/remarketing',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ reportingGuide = {
  name: 'Reporting Basics',
  urlPath: '/guides/reporting',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ resetDevtokenGuide = {
  name: 'Developer Token Reset',
  urlPath: '/guides/reset-devtoken',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ responsiveAdsGuide = {
  name: 'Responsive Ads for Display',
  urlPath: '/guides/responsive-ads',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ samplesUseCasesGuide = {
  name: 'Code Structure',
  urlPath: '/guides/samples-use-cases',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ shoppingGuide = {
  name: 'Shopping Campaigns',
  urlPath: '/guides/shopping',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ signupGuide = {
  name: 'Sign Up',
  urlPath: '/guides/signup',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ startGuide = {
  name: 'Get Started',
  urlPath: '/guides/start',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ structuredSnippetsGuide = {
  name: 'Structured Snippets',
  urlPath: '/guides/structured-snippets',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ targetingIdeaServiceGuide = {
  name: 'Generating Targeting Ideas',
  urlPath: '/guides/targeting-idea-service',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ targetingTypesGuide = {
  name: 'Targeting Types',
  urlPath: '/appendix/targetingtypes',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ templateAdsGuide = {
  name: 'Template Ads',
  urlPath: '/guides/template-ads',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ trafficEstimatorServiceGuide = {
  name: 'Estimating Traffic',
  urlPath: '/guides/traffic-estimator-service',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ troubleshootingGuide = {
  name: 'Troubleshooting',
  urlPath: '/guides/troubleshooting',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ uireportsGuide = {
  name: 'Mapping Reports to the Google Ads UI',
  urlPath: '/guides/uireports',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ upgradedUrlsGuide = {
  name: 'Upgraded URLs',
  urlPath: '/guides/upgraded-urls',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ valueTrackMappingGuide = {
  name: 'Mapping ValueTrack Parameters With Report Fields',
  urlPath: '/guides/valuetrack-mapping',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ verticalsGuide = {
  name: 'Verticals',
  urlPath: '/appendix/verticals',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ zeroimpressionStructureReportsGuide = {
  name: 'Zero Impression and Structure Reports',
  urlPath: '/guides/zeroimpression-structure-reports',
  category: ResourceCategory.GUIDE,
};

// AdWords API services.
const /** !Resource */ accountLabelService = {
  name: 'AccountLabelService',
  urlPath: '/reference/latest/AccountLabelService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adCustomizerFeedService = {
  name: 'AdCustomizerFeedService',
  urlPath: '/reference/latest/AdCustomizerFeedService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupAdService = {
  name: 'AdGroupAdService',
  urlPath: '/reference/latest/AdGroupAdService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupBidModifierService = {
  name: 'AdGroupBidModifierService',
  urlPath: '/reference/latest/AdGroupBidModifierService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupCriterionService = {
  name: 'AdGroupCriterionService',
  urlPath: '/reference/latest/AdGroupCriterionService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupExtensionSettingService = {
  name: 'AdGroupExtensionSettingService',
  urlPath: '/reference/latest/AdGroupExtensionSettingService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupFeedService = {
  name: 'AdGroupFeedService',
  urlPath: '/reference/latest/AdGroupFeedService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupService = {
  name: 'AdGroupService',
  urlPath: '/reference/latest/AdGroupService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupSettings = {
  name: 'AdGroup.settings',
  urlPath: '/reference/latest/AdGroupService.AdGroup#settings',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupContentBidCriterionTypeGroup = {
  name: 'AdGroup.contentBidCriterionTypeGroup',
  urlPath:
      '/reference/latest/AdGroupService.AdGroup#contentbidcriteriontypegroup',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupType = {
  name: 'AdGroup.adGroupType',
  urlPath: '/reference/latest/AdGroupService.AdGroup#adgrouptype',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupAdRotationMode = {
  name: 'AdGroup.adGroupAdRotationMode',
  urlPath: '/reference/latest/AdGroupService.AdGroup#adgroupadrotationmode',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adParamService = {
  name: 'AdParamService',
  urlPath: '/reference/latest/AdParamService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adService = {
  name: 'AdService',
  urlPath: '/reference/latest/AdService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adwordsUserListService = {
  name: 'AdwordsUserListService',
  urlPath: '/reference/latest/AdwordsUserListService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ assetService = {
  name: 'AssetService',
  urlPath: '/reference/latest/AssetService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ biddingStrategyService = {
  name: 'BiddingStrategyService',
  urlPath: '/reference/latest/BiddingStrategyService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ budgetOrderService = {
  name: 'BudgetOrderService',
  urlPath: '/reference/latest/BudgetOrderService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ budgetService = {
  name: 'BudgetService',
  urlPath: '/reference/latest/BudgetService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignBidModifierService = {
  name: 'CampaignBidModifierService',
  urlPath: '/reference/latest/CampaignBidModifierService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignCriterionService = {
  name: 'CampaignCriterionService',
  urlPath: '/reference/latest/CampaignCriterionService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignExtensionSettingService = {
  name: 'CampaignExtensionSettingService',
  urlPath: '/reference/latest/CampaignExtensionSettingService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignFeedService = {
  name: 'CampaignFeedService',
  urlPath: '/reference/latest/CampaignFeedService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignGroupPerformanceTargetService = {
  name: 'CampaignGroupPerformanceTargetService',
  urlPath: '/reference/latest/CampaignGroupPerformanceTargetService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignGroupService = {
  name: 'CampaignGroupService',
  urlPath: '/reference/latest/CampaignGroupService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignService = {
  name: 'CampaignService',
  urlPath: '/reference/latest/CampaignService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignSettings = {
  name: 'Campaign.settings',
  urlPath: '/reference/latest/CampaignService.Campaign#settings',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignBudget = {
  name: 'Campaign.budget',
  urlPath: '/reference/latest/CampaignService.Campaign#budget',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignBiddingStrategyConfiguration = {
  name: 'Campaign.biddingStrategyConfiguration',
  urlPath:
      '/reference/latest/CampaignService.Campaign#biddingStrategyConfiguration',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignNetworkSetting = {
  name: 'Campaign.networkSetting',
  urlPath: '/reference/latest/CampaignService.Campaign#networkSetting',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignSharedSetService = {
  name: 'CampaignSharedSetService',
  urlPath: '/reference/latest/CampaignSharedSetService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ constantDataService = {
  name: 'ConstantDataService',
  urlPath: '/reference/latest/ConstantDataService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ conversionTrackerService = {
  name: 'ConversionTrackerService',
  urlPath: '/reference/latest/ConversionTrackerService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customAffinityService = {
  name: 'CustomAffinityService',
  urlPath: '/reference/latest/CustomAffinityService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customerExtensionSettingService = {
  name: 'CustomerExtensionSettingService',
  urlPath: '/reference/latest/CustomerExtensionSettingService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customerFeedService = {
  name: 'CustomerFeedService',
  urlPath: '/reference/latest/CustomerFeedService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customerNegativeCriterionService = {
  name: 'CustomerNegativeCriterionService',
  urlPath: '/reference/latest/CustomerNegativeCriterionService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customerService = {
  name: 'CustomerService',
  urlPath: '/reference/latest/CustomerService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customerSyncService = {
  name: 'CustomerSyncService',
  urlPath: '/reference/latest/CustomerSyncService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ dataService = {
  name: 'DataService',
  urlPath: '/reference/latest/DataService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ draftAsyncErrorService = {
  name: 'DraftAsyncErrorService',
  urlPath: '/reference/latest/DraftAsyncErrorService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ draftService = {
  name: 'DraftService',
  urlPath: '/reference/latest/DraftService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ feedItemService = {
  name: 'FeedItemService',
  urlPath: '/reference/latest/FeedItemService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ feedItemTargetService = {
  name: 'FeedItemTargetService',
  urlPath: '/reference/latest/FeedItemTargetService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ feedMappingService = {
  name: 'FeedMappingService',
  urlPath: '/reference/latest/FeedMappingService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ feedService = {
  name: 'FeedService',
  urlPath: '/reference/latest/FeedService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ labelService = {
  name: 'LabelService',
  urlPath: '/reference/latest/LabelService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ locationCriterionService = {
  name: 'LocationCriterionService',
  urlPath: '/reference/latest/LocationCriterionService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ managedCustomerService = {
  name: 'ManagedCustomerService',
  urlPath: '/reference/latest/ManagedCustomerService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ mediaService = {
  name: 'MediaService',
  urlPath: '/reference/latest/MediaService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ offlineCallConversionFeedService = {
  name: 'OfflineCallConversionFeedService',
  urlPath: '/reference/latest/OfflineCallConversionFeedService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ offlineConversionAdjustmentFeedService = {
  name: 'OfflineConversionAdjustmentFeedService',
  urlPath: '/reference/latest/OfflineConversionAdjustmentFeedService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ offlineConversionFeedService = {
  name: 'OfflineConversionFeedService',
  urlPath: '/reference/latest/OfflineConversionFeedService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ reportDefinitionService = {
  name: 'ReportDefinitionService',
  urlPath: '/reference/latest/ReportDefinitionService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ sharedCriterionService = {
  name: 'SharedCriterionService',
  urlPath: '/reference/latest/SharedCriterionService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ sharedSetService = {
  name: 'SharedSetService',
  urlPath: '/reference/latest/SharedSetService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ targetingIdeaService = {
  name: 'TargetingIdeaService',
  urlPath: '/reference/latest/TargetingIdeaService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ trafficEstimatorService = {
  name: 'TrafficEstimatorService',
  urlPath: '/reference/latest/TrafficEstimatorService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ trialAsyncErrorService = {
  name: 'TrialAsyncErrorService',
  urlPath: '/reference/latest/TrialAsyncErrorService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ trialService = {
  name: 'TrialService',
  urlPath: '/reference/latest/TrialService',
  category: ResourceCategory.SERVICE,
};

// AdWords API reports.
const /** !Resource */ accountPerformanceReport = {
  name: 'Account Performance Report',
  urlPath: '/appendix/reports/account-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ adCustomizersFeedItemReport = {
  name: 'Ad Customizers Feed Item Report',
  urlPath: '/appendix/reports/ad-customizers-feed-item-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ adPerformanceReport = {
  name: 'Ad Performance Report',
  urlPath: '/appendix/reports/ad-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ adgroupPerformanceReport = {
  name: 'Adgroup Performance Report',
  urlPath: '/appendix/reports/adgroup-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ ageRangePerformanceReport = {
  name: 'Age Range Performance Report',
  urlPath: '/appendix/reports/age-range-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ allReports = {
  name: 'All reports',
  urlPath: '/appendix/reports/all-reports',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ audiencePerformanceReport = {
  name: 'Audience Performance Report',
  urlPath: '/appendix/reports/audience-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ automaticPlacementsPerformanceReport = {
  name: 'Automatic Placements Performance Report',
  urlPath: '/appendix/reports/automatic-placements-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ bidGoalPerformanceReport = {
  name: 'Bid Goal Performance Report',
  urlPath: '/appendix/reports/bid-goal-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ budgetPerformanceReport = {
  name: 'Budget Performance Report',
  urlPath: '/appendix/reports/budget-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ callMetricsCallDetailsReport = {
  name: 'Call Metrics Call Details Report',
  urlPath: '/appendix/reports/call-metrics-call-details-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ campaignAdScheduleTargetReport = {
  name: 'Campaign Ad Schedule Target Report',
  urlPath: '/appendix/reports/campaign-ad-schedule-target-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ campaignCriteriaReport = {
  name: 'Campaign Criteria Report',
  urlPath: '/appendix/reports/campaign-criteria-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ campaignGroupPerformanceReport = {
  name: 'Campaign Group Performance Report',
  urlPath: '/appendix/reports/campaign-group-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ campaignLocationTargetReport = {
  name: 'Campaign Location Target Report',
  urlPath: '/appendix/reports/campaign-location-target-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ campaignNegativeKeywordsPerformanceReport = {
  name: 'Campaign Negative Keywords Performance Report',
  urlPath: '/appendix/reports/campaign-negative-keywords-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ campaignNegativeLocationsReport = {
  name: 'Campaign Negative Locations Report',
  urlPath: '/appendix/reports/campaign-negative-locations-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ campaignNegativePlacementsPerformanceReport = {
  name: 'Campaign Negative Placements Performance Report',
  urlPath: '/appendix/reports/campaign-negative-placements-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ campaignPerformanceReport = {
  name: 'Campaign Performance Report',
  urlPath: '/appendix/reports/campaign-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ campaignSharedSetReport = {
  name: 'Campaign Shared Set Report',
  urlPath: '/appendix/reports/campaign-shared-set-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ clickPerformanceReport = {
  name: 'Click Performance Report',
  urlPath: '/appendix/reports/click-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ criteriaPerformanceReport = {
  name: 'Criteria Performance Report',
  urlPath: '/appendix/reports/criteria-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ displayKeywordPerformanceReport = {
  name: 'Display Keyword Performance Report',
  urlPath: '/appendix/reports/display-keyword-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ displayTopicsPerformanceReport = {
  name: 'Display Topics Performance Report',
  urlPath: '/appendix/reports/display-topics-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ finalUrlReport = {
  name: 'Final Url Report',
  urlPath: '/appendix/reports/final-url-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ genderPerformanceReport = {
  name: 'Gender Performance Report',
  urlPath: '/appendix/reports/gender-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ geoPerformanceReport = {
  name: 'Geo Performance Report',
  urlPath: '/appendix/reports/geo-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ keywordlessCategoryReport = {
  name: 'Keywordless Category Report',
  urlPath: '/appendix/reports/keywordless-category-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ keywordlessQueryReport = {
  name: 'Keywordless Query Report',
  urlPath: '/appendix/reports/keywordless-query-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ keywordsPerformanceReport = {
  name: 'Keywords Performance Report',
  urlPath: '/appendix/reports/keywords-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ labelReport = {
  name: 'Label Report',
  urlPath: '/appendix/reports/label-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ landingPageReport = {
  name: 'Landing Page Report',
  urlPath: '/appendix/reports/landing-page-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ paidOrganicQueryReport = {
  name: 'Paid Organic Query Report',
  urlPath: '/appendix/reports/paid-organic-query-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ parentalStatusPerformanceReport = {
  name: 'Parental Status Performance Report',
  urlPath: '/appendix/reports/parental-status-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ placeholderFeedItemReport = {
  name: 'Placeholder Feed Item Report',
  urlPath: '/appendix/reports/placeholder-feed-item-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ placeholderReport = {
  name: 'Placeholder Report',
  urlPath: '/appendix/reports/placeholder-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ placementPerformanceReport = {
  name: 'Placement Performance Report',
  urlPath: '/appendix/reports/placement-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ productPartitionReport = {
  name: 'Product Partition Report',
  urlPath: '/appendix/reports/product-partition-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ searchQueryPerformanceReport = {
  name: 'Search Query Performance Report',
  urlPath: '/appendix/reports/search-query-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ sharedSetCriteriaReport = {
  name: 'Shared Set Criteria Report',
  urlPath: '/appendix/reports/shared-set-criteria-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ sharedSetReport = {
  name: 'Shared Set Report',
  urlPath: '/appendix/reports/shared-set-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ shoppingPerformanceReport = {
  name: 'Shopping Performance Report',
  urlPath: '/appendix/reports/shopping-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ topContentPerformanceReport = {
  name: 'Top Content Performance Report',
  urlPath: '/appendix/reports/top-content-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ urlPerformanceReport = {
  name: 'Url Performance Report',
  urlPath: '/appendix/reports/url-performance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ userAdDistanceReport = {
  name: 'User Ad Distance Report',
  urlPath: '/appendix/reports/user-ad-distance-report',
  category: ResourceCategory.REPORT,
};
const /** !Resource */ videoPerformanceReport = {
  name: 'Video Performance Report',
  urlPath: '/appendix/reports/video-performance-report',
  category: ResourceCategory.REPORT,
};

// Google Ads API guides.
const /** !Resource */ accessLevelsGuide = {
  name: 'Access Levels and Permissible Use',
  urlPath: '/access-levels',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ accountManagementGuide = {
  name: 'Account Management',
  urlPath: '/account-management/overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ appCampaignsGuide = {
  name: 'App Campaigns',
  urlPath: '/app-campaigns/overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ batchProcessingGuide = {
  name: 'Batch Processing',
  urlPath: '/batch-processing/overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ billingAccountBudgetsGuide = {
  name: 'Account Budget',
  urlPath: '/billing/account-budgets',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ billingBillingSetupsGuide = {
  name: 'Billing Setup',
  urlPath: '/billing/billing-setups',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ billingOverviewGuide = {
  name: 'Billing',
  urlPath: '/billing/overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ campaignsCreateAdGroupsGuide = {
  name: 'Create Ad Groups',
  urlPath: '/campaigns/create-ad-groups',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ campaignsCreateAdsGuide = {
  name: 'Create Ads',
  urlPath: '/campaigns/create-ads',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ campaignsCreateCampaignsGuide = {
  name: 'Create Campaigns',
  urlPath: '/campaigns/create-campaigns',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ gaapiCampaignsOverviewGuide = {
  name: 'Campaigns',
  urlPath: '/campaigns/overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ changeStatusGuide = {
  name: 'Change Status Service',
  urlPath: '/change-status',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ clientLibrariesGuide = {
  name: 'Client Libraries',
  urlPath: '/client-libs',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ conceptsApiStructureGuide = {
  name: 'API Structure',
  urlPath: '/concepts/api-structure',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ conceptsCallStructureGuide = {
  name: 'API Call Structure',
  urlPath: '/concepts/call-structure',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ conceptsChangingObjectsGuide = {
  name: 'Changing and Inspecting Objects',
  urlPath: '/concepts/changing-objects',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ conceptsFieldServiceGuide = {
  name: 'Resource Metadata',
  urlPath: '/concepts/field-service',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ conceptsOverviewGuide = {
  name: 'API Overview',
  urlPath: '/concepts/overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ conceptsRetrievingObjectsGuide = {
  name: 'Retrieving Objects',
  urlPath: '/concepts/retrieving-objects',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ conversionsOverviewGuide = {
  name: 'Conversions',
  urlPath: '/conversions',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ firstCallDevTokenGuide = {
  name: 'Obtain Your Developer Token',
  urlPath: '/first-call/dev-token',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ firstCallGetClientLibGuide = {
  name: 'Get a Client Library',
  urlPath: '/first-call/get-client-lib',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ firstCallOverviewGuide = {
  name: 'Quickstart',
  urlPath: '/first-call/overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ firstCallRefreshTokenGuide = {
  name: 'Get an OAuth2 Refresh Token and Configure Your Client',
  urlPath: '/first-call/refresh-token',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ hotelAdsOverviewGuide = {
  name: 'Hotel Ads',
  urlPath: '/hotel-ads/overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ hotelAdsReportingGuide = {
  name: 'Hotel Ads Reporting',
  urlPath: '/hotel-ads/reporting',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ migrationOverviewGuide = {
  name: 'Migrating from the AdWords API to the Google Ads API',
  urlPath: '/migration',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ oauthOverviewGuide = {
  name: 'OAuth2 in the Google Ads API',
  urlPath: '/oauth/overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ partialFailuresGuide = {
  name: 'Partial Failures',
  urlPath: '/partial-failures',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ queryOverviewGuide = {
  name: 'Google Ads Query Language',
  urlPath: '/query/overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ rateSheetGuide = {
  name: 'Rate Sheet and Non-Compliance Fees',
  urlPath: '/rate-sheet',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ reportingCriteriaMetricsGuide = {
  name: 'Criteria Metrics',
  urlPath: '/reporting/criteria-metrics',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ reportingExampleGuide = {
  name: 'Example',
  urlPath: '/reporting/example',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ reportingOverviewGuide = {
  name: 'Reporting',
  urlPath: '/reporting/overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ reportingZeroImpressionsGuide = {
  name: 'Zero Impressions',
  urlPath: '/reporting/zero-impressions',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ bestPracticesGuide = {
  name: 'Best Practices',
  urlPath: '/best-practices/overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ bestPracticesApiLimitsGuide = {
  name: 'API Limits and Quotas',
  urlPath: '/best-practices/quotas',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ bestPracticesRateLimitsGuide = {
  name: 'Rate Limits',
  urlPath: '/best-practices/rate-limits',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ bestPractiesTroubleshootingGuide = {
  name: 'Troubleshooting',
  urlPath: '/best-practices/troubleshooting',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ gaapiEntityRelationshipsGuide = {
  name: 'Entity Relationships',
  urlPath: '/entity-relationships',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ recommendationsGuide = {
  name: 'Recommendation Service',
  urlPath: '/recommendations',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ rmfGuide = {
  name: 'Required Minimum Functionality',
  urlPath: '/rmf',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ serviceAccountsGuide = {
  name: 'Service Accounts',
  urlPath: '/oauth/service-accounts',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ gaapiStartGuide = {
  name: 'Product Overview',
  urlPath: '/start',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ shoppingAdsOverviewGuide = {
  name: 'Shopping Ads',
  urlPath: '/shopping-ads/overview',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ shoppingAdsReportingGuide = {
  name: 'Shopping Reporting',
  urlPath: '/shopping-ads/reporting',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ targetingBidModifiersGuide = {
  name: 'Bid modifiers',
  urlPath: '/targeting/bid-modifiers',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ targetingLocationTargetingGuide = {
  name: 'Location Targeting',
  urlPath: '/targeting/location-targeting',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ targetingCriteriaGuide = {
  name: 'Criteria',
  urlPath: '/targeting/criteria',
  category: ResourceCategory.GUIDE,
};
const /** !Resource */ targetingOverviewGuide = {
  name: 'Targeting',
  urlPath: '/targeting/overview',
  category: ResourceCategory.GUIDE,
};

// Google Ads API services.
const /** !Resource */ accountBudgetProposalServiceRef = {
  name: 'AccountBudgetProposalService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AccountBudgetProposalService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ accountBudgetServiceRef = {
  name: 'AccountBudgetService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AccountBudgetService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupAdLabelServiceRef = {
  name: 'AdGroupAdLabelService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdGroupAdLabelService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupAdServiceRef = {
  name: 'AdGroupAdService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdGroupAdService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupAudienceViewServiceRef = {
  name: 'AdGroupAudienceViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdGroupAudienceViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupBidModifierServiceRef = {
  name: 'AdGroupBidModifierService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdGroupBidModifierService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupCriterionLabelServiceRef = {
  name: 'AdGroupCriterionLabelService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdGroupCriterionLabelService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupCriterionServiceRef = {
  name: 'AdGroupCriterionService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdGroupCriterionService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupCriterionSimulationServiceRef = {
  name: 'AdGroupCriterionSimulationService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdGroupCriterionSimulationService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupExtensionSettingServiceRef = {
  name: 'AdGroupExtensionSettingService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdGroupExtensionSettingService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupFeedServiceRef = {
  name: 'AdGroupFeedService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdGroupFeedService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupLabelServiceRef = {
  name: 'AdGroupLabelService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdGroupLabelService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupServiceRef = {
  name: 'AdGroupService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdGroupService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adGroupSimulationServiceRef = {
  name: 'AdGroupSimulationService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdGroupSimulationService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adParameterServiceRef = {
  name: 'AdParameterService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdParameterService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ adScheduleViewServiceRef = {
  name: 'AdScheduleViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AdScheduleViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ ageRangeViewServiceRef = {
  name: 'AgeRangeViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AgeRangeViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ assetServiceRef = {
  name: 'AssetService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.AssetService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ biddingStrategyServiceRef = {
  name: 'BiddingStrategyService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.BiddingStrategyService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ billingSetupServiceRef = {
  name: 'BillingSetupService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.BillingSetupService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignAudienceViewServiceRef = {
  name: 'CampaignAudienceViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CampaignAudienceViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignBidModifierServiceRef = {
  name: 'CampaignBidModifierService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CampaignBidModifierService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignBudgetServiceRef = {
  name: 'CampaignBudgetService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CampaignBudgetService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignCriterionServiceRef = {
  name: 'CampaignCriterionService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CampaignCriterionService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignCriterionSimulationServiceRef = {
  name: 'CampaignCriterionSimulationService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CampaignCriterionSimulationService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignExtensionSettingServiceRef = {
  name: 'CampaignExtensionSettingService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CampaignExtensionSettingService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignFeedServiceRef = {
  name: 'CampaignFeedService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CampaignFeedService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignLabelServiceRef = {
  name: 'CampaignLabelService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CampaignLabelService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignServiceRef = {
  name: 'CampaignService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CampaignService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ campaignSharedSetServiceRef = {
  name: 'CampaignSharedSetService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CampaignSharedSetService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ carrierConstantServiceRef = {
  name: 'CarrierConstantService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CarrierConstantService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ changeStatusServiceRef = {
  name: 'ChangeStatusService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.ChangeStatusService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ clickViewServiceRef = {
  name: 'ClickViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.ClickViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ conversionActionServiceRef = {
  name: 'ConversionActionService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.ConversionActionService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ conversionAdjustmentUploadServiceRef = {
  name: 'ConversionAdjustmentUploadService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.ConversionAdjustmentUploadService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ conversionUploadServiceRef = {
  name: 'ConversionUploadService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.ConversionUploadService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customInterestServiceRef = {
  name: 'CustomInterestService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CustomInterestService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customerClientLinkServiceRef = {
  name: 'CustomerClientLinkService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CustomerClientLinkService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customerClientServiceRef = {
  name: 'CustomerClientService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CustomerClientService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customerExtensionSettingServiceRef = {
  name: 'CustomerExtensionSettingService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CustomerExtensionSettingService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customerFeedServiceRef = {
  name: 'CustomerFeedService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CustomerFeedService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customerLabelServiceRef = {
  name: 'CustomerLabelService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CustomerLabelService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customerManagerLinkServiceRef = {
  name: 'CustomerManagerLinkService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CustomerManagerLinkService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customerNegativeCriterionServiceRef = {
  name: 'CustomerNegativeCriterionService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CustomerNegativeCriterionService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ customerServiceRef = {
  name: 'CustomerService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.CustomerService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ detailPlacementViewServiceRef = {
  name: 'DetailPlacementViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.DetailPlacementViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ displayKeywordViewServiceRef = {
  name: 'DisplayKeywordViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.DisplayKeywordViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ domainCategoryServiceRef = {
  name: 'DomainCategoryService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.DomainCategoryService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ dynamicSearchAdsSearchTermViewServiceRef = {
  name: 'DynamicSearchAdsSearchTermViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.DynamicSearchAdsSearchTermViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ expandedLandingPageViewServiceRef = {
  name: 'ExpandedLandingPageViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.ExpandedLandingPageViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ extensionFeedItemServiceRef = {
  name: 'ExtensionFeedItemService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.ExtensionFeedItemService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ feedItemServiceRef = {
  name: 'FeedItemService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.FeedItemService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ feedItemTargetServiceRef = {
  name: 'FeedItemTargetService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.FeedItemTargetService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ feedMappingServiceRef = {
  name: 'FeedMappingService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.FeedMappingService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ feedPlaceholderViewServiceRef = {
  name: 'FeedPlaceholderViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.FeedPlaceholderViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ feedServiceRef = {
  name: 'FeedService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.FeedService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ genderViewServiceRef = {
  name: 'GenderViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.GenderViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ geoTargetConstantServiceRef = {
  name: 'GeoTargetConstantService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.GeoTargetConstantService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ geographicViewServiceRef = {
  name: 'GeographicViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.GeographicViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ googleAdsFieldServiceRef = {
  name: 'GoogleAdsFieldService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.GoogleAdsFieldService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ googleAdsServiceRef = {
  name: 'GoogleAdsService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.GoogleAdsService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ groupPlacementViewServiceRef = {
  name: 'GroupPlacementViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.GroupPlacementViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ hotelGroupViewServiceRef = {
  name: 'HotelGroupViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.HotelGroupViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ hotelPerformanceViewServiceRef = {
  name: 'HotelPerformanceViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.HotelPerformanceViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ keywordPlanAdGroupServiceRef = {
  name: 'KeywordPlanAdGroupService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.KeywordPlanAdGroupService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ keywordPlanCampaignServiceRef = {
  name: 'KeywordPlanCampaignService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.KeywordPlanCampaignService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ keywordPlanIdeaServiceRef = {
  name: 'KeywordPlanIdeaService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.KeywordPlanIdeaService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ keywordPlanKeywordServiceRef = {
  name: 'KeywordPlanKeywordService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.KeywordPlanKeywordService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ keywordPlanNegativeKeywordServiceRef = {
  name: 'KeywordPlanNegativeKeywordService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.KeywordPlanNegativeKeywordService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ keywordPlanServiceRef = {
  name: 'KeywordPlanService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.KeywordPlanService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ keywordViewServiceRef = {
  name: 'KeywordViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.KeywordViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ labelServiceRef = {
  name: 'LabelService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.LabelService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ landingPageViewServiceRef = {
  name: 'LandingPageViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.LandingPageViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ languageConstantServiceRef = {
  name: 'LanguageConstantService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.LanguageConstantService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ locationViewServiceRef = {
  name: 'LocationViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.LocationViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ managedPlacementViewServiceRef = {
  name: 'ManagedPlacementViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.ManagedPlacementViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ mediaFileServiceRef = {
  name: 'MediaFileService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.MediaFileService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ merchantCenterLinkServiceRef = {
  name: 'MerchantCenterLinkService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.MerchantCenterLinkService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ mobileAppCategoryConstantServiceRef = {
  name: 'MobileAppCategoryConstantService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.MobileAppCategoryConstantService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ mobileDeviceConstantServiceRef = {
  name: 'MobileDeviceConstantService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.MobileDeviceConstantService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ operatingSystemVersionConstantServiceRef = {
  name: 'OperatingSystemVersionConstantService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.OperatingSystemVersionConstantService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ paidOrganicSearchTermViewServiceRef = {
  name: 'PaidOrganicSearchTermViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.PaidOrganicSearchTermViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ parentalStatusViewServiceRef = {
  name: 'ParentalStatusViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.ParentalStatusViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ paymentsAccountServiceRef = {
  name: 'PaymentsAccountService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.PaymentsAccountService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ productBiddingCategoryConstantServiceRef = {
  name: 'ProductBiddingCategoryConstantService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.ProductBiddingCategoryConstantService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ productGroupViewServiceRef = {
  name: 'ProductGroupViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.ProductGroupViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ recommendationServiceRef = {
  name: 'RecommendationService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.RecommendationService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ remarketingActionServiceRef = {
  name: 'RemarketingActionService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.RemarketingActionService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ searchTermViewServiceRef = {
  name: 'SearchTermViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.SearchTermViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ sharedCriterionServiceRef = {
  name: 'SharedCriterionService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.SharedCriterionService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ sharedSetServiceRef = {
  name: 'SharedSetService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.SharedSetService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ shoppingPerformanceViewServiceRef = {
  name: 'ShoppingPerformanceViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.ShoppingPerformanceViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ topicConstantServiceRef = {
  name: 'TopicConstantService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.TopicConstantService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ topicViewServiceRef = {
  name: 'TopicViewService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.TopicViewService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ userInterestServiceRef = {
  name: 'UserInterestService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.UserInterestService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ userListServiceRef = {
  name: 'UserListService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.UserListService',
  category: ResourceCategory.SERVICE,
};
const /** !Resource */ videoServiceRef = {
  name: 'VideoService',
  urlPath:
      '/rpc/google.ads.googleads.v2.services#google.ads.googleads.v2.services.VideoService',
  category: ResourceCategory.SERVICE,
};

// Google Ads API field reference pages.
const /** !Resource */ accountBudgetFieldRef = {
  name: 'account_budget',
  urlPath: '/account_budget',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ accountBudgetProposalFieldRef = {
  name: 'account_budget_proposal',
  urlPath: '/account_budget_proposal',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adGroupFieldRef = {
  name: 'ad_group',
  urlPath: '/ad_group',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adGroupAdFieldRef = {
  name: 'ad_group_ad',
  urlPath: '/ad_group_ad',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adGroupAdLabelFieldRef = {
  name: 'ad_group_ad_label',
  urlPath: '/ad_group_ad_label',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adGroupAudienceViewFieldRef = {
  name: 'ad_group_audience_view',
  urlPath: '/ad_group_audience_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adGroupBidModifierFieldRef = {
  name: 'ad_group_bid_modifier',
  urlPath: '/ad_group_bid_modifier',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adGroupCriterionFieldRef = {
  name: 'ad_group_criterion',
  urlPath: '/ad_group_criterion',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adGroupCriterionLabelFieldRef = {
  name: 'ad_group_criterion_label',
  urlPath: '/ad_group_criterion_label',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adGroupCriterionSimulationFieldRef = {
  name: 'ad_group_criterion_simulation',
  urlPath: '/ad_group_criterion_simulation',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adGroupExtensionSettingFieldRef = {
  name: 'ad_group_extension_setting',
  urlPath: '/ad_group_extension_setting',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adGroupFeedFieldRef = {
  name: 'ad_group_feed',
  urlPath: '/ad_group_feed',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adGroupLabelFieldRef = {
  name: 'ad_group_label',
  urlPath: '/ad_group_label',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adGroupSimulationFieldRef = {
  name: 'ad_group_simulation',
  urlPath: '/ad_group_simulation',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adNetworkTypeFieldRef = {
  name: 'segments.ad_network_type',
  urlPath: '/segments#segmentsad_network_type',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adParameterFieldRef = {
  name: 'ad_parameter',
  urlPath: '/ad_parameter',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ adScheduleViewFieldRef = {
  name: 'ad_schedule_view',
  urlPath: '/ad_schedule_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ ageRangeViewFieldRef = {
  name: 'age_range_view',
  urlPath: '/age_range_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ assetFieldRef = {
  name: 'asset',
  urlPath: '/asset',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ biddingStrategyFieldRef = {
  name: 'bidding_strategy',
  urlPath: '/bidding_strategy',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ billingSetupFieldRef = {
  name: 'billing_setup',
  urlPath: '/billing_setup',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ campaignFieldRef = {
  name: 'campaign',
  urlPath: '/campaign',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ campaignAudienceViewFieldRef = {
  name: 'campaign_audience_view',
  urlPath: '/campaign_audience_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ campaignBidModifierFieldRef = {
  name: 'campaign_bid_modifier',
  urlPath: '/campaign_bid_modifier',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ campaignBudgetFieldRef = {
  name: 'campaign_budget',
  urlPath: '/campaign_budget',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ campaignCriterionFieldRef = {
  name: 'campaign_criterion',
  urlPath: '/campaign_criterion',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ campaignCriterionSimulationFieldRef = {
  name: 'campaign_criterion_simulation',
  urlPath: '/campaign_criterion_simulation',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ campaignExtensionSettingFieldRef = {
  name: 'campaign_extension_setting',
  urlPath: '/campaign_extension_setting',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ campaignFeedFieldRef = {
  name: 'campaign_feed',
  urlPath: '/campaign_feed',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ campaignLabelFieldRef = {
  name: 'campaign_label',
  urlPath: '/campaign_label',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ campaignSharedSetFieldRef = {
  name: 'campaign_shared_set',
  urlPath: '/campaign_shared_set',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ carrierConstantFieldRef = {
  name: 'carrier_constant',
  urlPath: '/carrier_constant',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ changeStatusFieldRef = {
  name: 'change_status',
  urlPath: '/change_status',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ clickViewFieldRef = {
  name: 'click_view',
  urlPath: '/click_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ conversionActionFieldRef = {
  name: 'conversion_action',
  urlPath: '/conversion_action',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ customInterestFieldRef = {
  name: 'custom_interest',
  urlPath: '/custom_interest',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ customerFieldRef = {
  name: 'customer',
  urlPath: '/customer',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ customerClientFieldRef = {
  name: 'customer_client',
  urlPath: '/customer_client',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ customerClientLinkFieldRef = {
  name: 'customer_client_link',
  urlPath: '/customer_client_link',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ customerExtensionSettingFieldRef = {
  name: 'customer_extension_setting',
  urlPath: '/customer_extension_setting',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ customerFeedFieldRef = {
  name: 'customer_feed',
  urlPath: '/customer_feed',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ customerLabelFieldRef = {
  name: 'customer_label',
  urlPath: '/customer_label',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ customerManagerLinkFieldRef = {
  name: 'customer_manager_link',
  urlPath: '/customer_manager_link',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ customerNegativeCriterionFieldRef = {
  name: 'customer_negative_criterion',
  urlPath: '/customer_negative_criterion',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ detailPlacementViewFieldRef = {
  name: 'detail_placement_view',
  urlPath: '/detail_placement_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ dateFieldRef = {
  name: 'segments.date',
  urlPath: '/segments#segmentsdate',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ dayOfWeekFieldRef = {
  name: 'segments.day_of_week',
  urlPath: '/segments#segmentsday_of_week',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ deviceFieldRef = {
  name: 'segments.device',
  urlPath: '/segments#segmentsdevice',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ displayKeywordViewFieldRef = {
  name: 'display_keyword_view',
  urlPath: '/display_keyword_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ domainCategoryFieldRef = {
  name: 'domain_category',
  urlPath: '/domain_category',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ dynamicSearchAdsSearchTermViewFieldRef = {
  name: 'dynamic_search_ads_search_term_view',
  urlPath: '/dynamic_search_ads_search_term_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ expandedLandingPageViewFieldRef = {
  name: 'expanded_landing_page_view',
  urlPath: '/expanded_landing_page_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ extensionFeedItemFieldRef = {
  name: 'extension_feed_item',
  urlPath: '/extension_feed_item',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ feedFieldRef = {
  name: 'feed',
  urlPath: '/feed',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ feedItemFieldRef = {
  name: 'feed_item',
  urlPath: '/feed_item',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ feedItemTargetFieldRef = {
  name: 'feed_item_target',
  urlPath: '/feed_item_target',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ feedMappingFieldRef = {
  name: 'feed_mapping',
  urlPath: '/feed_mapping',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ feedPlaceholderViewFieldRef = {
  name: 'feed_placeholder_view',
  urlPath: '/feed_placeholder_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ genderViewFieldRef = {
  name: 'gender_view',
  urlPath: '/gender_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ geographicViewFieldRef = {
  name: 'geographic_view',
  urlPath: '/geographic_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ geoTargetConstantFieldRef = {
  name: 'geo_target_constant',
  urlPath: '/geo_target_constant',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ geoTargetCountyFieldRef = {
  name: 'segments.geo_target_county',
  urlPath: '/segments#segmentsgeo_target_county',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ geoTargetDistrictFieldRef = {
  name: 'segments.geo_target_district',
  urlPath: '/segments#segmentsgeo_target_district',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ geoTargetMostSpecificLocationFieldRef = {
  name: 'segments.geo_target_most_specific_location',
  urlPath: '/segments#segmentsgeo_target_most_specific_location',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ geoTargetPostalCodeFieldRef = {
  name: 'segments.geo_target_postal_code',
  urlPath: '/segments#segmentsgeo_target_postal_code',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ geoTargetStateFieldRef = {
  name: 'segments.geo_target_state',
  urlPath: '/segments#segmentsgeo_target_state',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ groupPlacementViewFieldRef = {
  name: 'group_placement_view',
  urlPath: '/group_placement_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ hotelBookingWindowDaysFieldRef = {
  name: 'segments.hotel_booking_window_days',
  urlPath: '/segments#segmentshotel_booking_window_days',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ hotelCenterIdFieldRef = {
  name: 'segments.hotel_center_id',
  urlPath: '/segments#segmentshotel_center_id',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ hotelCheckInDateFieldRef = {
  name: 'segments.hotel_check_in_date',
  urlPath: '/segments#segmentshotel_check_in_date',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ hotelCheckInDayOfWeekFieldRef = {
  name: 'segments.hotel_check_in_day_of_week',
  urlPath: '/segments#segmentshotel_check_in_day_of_week',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ hotelCityFieldRef = {
  name: 'segments.hotel_city',
  urlPath: '/segments#segmentshotel_city',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ hotelClassFieldRef = {
  name: 'segments.hotel_class',
  urlPath: '/segments#segmentshotel_class',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ hotelCountryFieldRef = {
  name: 'segments.hotel_country',
  urlPath: '/segments#segmentshotel_country',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ hotelDateSelectionTypeFieldRef = {
  name: 'segments.hotel_date_selection_type',
  urlPath: '/segments#segmentshotel_date_selection_type',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ hotelGroupViewFieldRef = {
  name: 'hotel_group_view',
  urlPath: '/hotel_group_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ hotelLengthOfStayFieldRef = {
  name: 'segments.hotel_length_of_stay',
  urlPath: '/segments#segmentshotel_length_of_stay',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ hotelPerformanceViewFieldRef = {
  name: 'hotel_performance_view',
  urlPath: '/hotel_performance_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ hotelStateFieldRef = {
  name: 'segments.hotel_state',
  urlPath: '/segments#segmentshotel_state',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ hourFieldRef = {
  name: 'segments.hour',
  urlPath: '/segments#segmentshour',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ keywordPlanFieldRef = {
  name: 'keyword_plan',
  urlPath: '/keyword_plan',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ keywordPlanAdGroupFieldRef = {
  name: 'keyword_plan_ad_group',
  urlPath: '/keyword_plan_ad_group',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ keywordPlanCampaignFieldRef = {
  name: 'keyword_plan_campaign',
  urlPath: '/keyword_plan_campaign',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ keywordPlanKeywordFieldRef = {
  name: 'keyword_plan_keyword',
  urlPath: '/keyword_plan_keyword',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ keywordPlanNegativeKeywordFieldRef = {
  name: 'keyword_plan_negative_keyword',
  urlPath: '/keyword_plan_negative_keyword',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ keywordViewFieldRef = {
  name: 'keyword_view',
  urlPath: '/keyword_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ labelFieldRef = {
  name: 'label',
  urlPath: '/label',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ landingPageViewFieldRef = {
  name: 'landing_page_view',
  urlPath: '/landing_page_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ languageConstantFieldRef = {
  name: 'language_constant',
  urlPath: '/language_constant',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ locationViewFieldRef = {
  name: 'location_view',
  urlPath: '/location_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ managedPlacementViewFieldRef = {
  name: 'managed_placement_view',
  urlPath: '/managed_placement_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ mediaFileFieldRef = {
  name: 'media_file',
  urlPath: '/media_file',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ metricsFieldRef = {
  name: 'metrics',
  urlPath: '/metrics',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ mobileAppCategoryConstantFieldRef = {
  name: 'mobile_app_category_constant',
  urlPath: '/mobile_app_category_constant',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ mobileDeviceConstantFieldRef = {
  name: 'mobile_device_constant',
  urlPath: '/mobile_device_constant',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ monthFieldRef = {
  name: 'segments.month',
  urlPath: '/segments#segmentsmonth',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ monthOfYearFieldRef = {
  name: 'segments.month_of_year',
  urlPath: '/segments#segmentsmonth_of_year',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ operatingSystemVersionConstantFieldRef = {
  name: 'operating_system_version_constant',
  urlPath: '/operating_system_version_constant',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ paidOrganicSearchTermViewFieldRef = {
  name: 'paid_organic_search_term_view',
  urlPath: '/paid_organic_search_term_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ parentalStatusViewFieldRef = {
  name: 'parental_status_view',
  urlPath: '/parental_status_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ partnerHotelIdFieldRef = {
  name: 'segments.partner_hotel_id',
  urlPath: '/segments#segmentspartner_hotel_id',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ placeholderTypeFieldRef = {
  name: 'segments.placeholder_type',
  urlPath: '/segments#segmentsplaceholder_type',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ productBiddingCategoryConstantFieldRef = {
  name: 'product_bidding_category_constant',
  urlPath: '/product_bidding_category_constant',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ productGroupViewFieldRef = {
  name: 'product_group_view',
  urlPath: '/product_group_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ quarterFieldRef = {
  name: 'segments.quarter',
  urlPath: '/segments#segmentsquarter',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ recommendationFieldRef = {
  name: 'recommendation',
  urlPath: '/recommendation',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ remarketingActionFieldRef = {
  name: 'remarketing_action',
  urlPath: '/remarketing_action',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ searchEngineResultsPageTypeFieldRef = {
  name: 'segments.search_engine_results_page_type',
  urlPath: '/segments#segmentssearch_engine_results_page_type',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ searchTermMatchTypeFieldRef = {
  name: 'segments.search_term_match_type',
  urlPath: '/segments#segmentssearch_term_match_type',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ searchTermViewFieldRef = {
  name: 'search_term_view',
  urlPath: '/search_term_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ sharedCriterionFieldRef = {
  name: 'shared_criterion',
  urlPath: '/shared_criterion',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ sharedSetFieldRef = {
  name: 'shared_set',
  urlPath: '/shared_set',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ slotFieldRef = {
  name: 'segments.slot',
  urlPath: '/segments#segmentsslot',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ shoppingPerformanceViewFieldRef = {
  name: 'shopping_performance_view',
  urlPath: '/shopping_performance_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ topicConstantFieldRef = {
  name: 'topic_constant',
  urlPath: '/topic_constant',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ topicViewFieldRef = {
  name: 'topic_view',
  urlPath: '/topic_view',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ userInterestFieldRef = {
  name: 'user_interest',
  urlPath: '/user_interest',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ userListFieldRef = {
  name: 'user_list',
  urlPath: '/user_list',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ videoFieldRef = {
  name: 'video',
  urlPath: '/video',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ weekFieldRef = {
  name: 'segments.week',
  urlPath: '/segments#segmentsweek',
  category: ResourceCategory.FIELD,
};
const /** !Resource */ yearFieldRef = {
  name: 'segments.year',
  urlPath: '/segments#segmentsyear',
  category: ResourceCategory.FIELD,
};

// Google Ads API pages stored at root.

const /** !Resource */ googleAdsDeveloperStarterChecklistPage = {
  name: 'Google Ads Developer Starter Checklist',
  urlPath: '/starter-checklist',
  category: ResourceCategory.GAAPI_ROOT,
};
const /** !Resource */ workshopsPage = {
  name: 'Workshops',
  urlPath: '/workshops',
  category: ResourceCategory.GAAPI_ROOT,
};
...
/**
 * A mapping from AWN URL paths to their relevant resources for both AdWords API
 * and Google Ads API.
 */
const /** !Object<string, !ResourcesForProducts> */ urlPathsToResources = {
  'overview': {
    awapiResources: [
      reportingGuide,
      startGuide,
      firstApiCallGuide,
      samplesUseCasesGuide,
      callStructureGuide,
      bestpracticesGuide,
      entityRelationshipsGuide,
      allReports,
    ],
    gaapiResources: [
      googleAdsDeveloperStarterChecklistPage,
      gaapiStartGuide,
      migrationOverviewGuide,
      firstCallOverviewGuide,
      conceptsApiStructureGuide,
      conceptsCallStructureGuide,
      rmfGuide,
      gaapiEntityRelationshipsGuide,
      firstCallGetClientLibGuide,
      firstCallRefreshTokenGuide,
      firstCallDevTokenGuide,
      oauthOverviewGuide,
      clientLibrariesGuide,
      bestPracticesGuide,
      bestPracticesApiLimitsGuide,
      bestPracticesRateLimitsGuide,
      batchProcessingGuide,
      googleAdsServiceRef,
      googleAdsFieldServiceRef,
      workshopsPage,
    ],
  },
  'opportunities': {
    awapiResources: [],
    gaapiResources: [
      recommendationsGuide,
      recommendationServiceRef,
      recommendationFieldRef,
    ],
  },
  'apicenter': {
    awapiResources: [
    ...
    gaapiResources: [
      ...
      bestPracticesApiLimitsGuide,
      bestPracticesRateLimitsGuide,
      bestPractiesTroubleshootingGuide,
      batchProcessingGuide,
      partialFailuresGuide,
      oauthOverviewGuide,
      serviceAccountsGuide,
      workshopsPage,
    ],
  },
  'accounts': {
    awapiResources: [
      accountsOverviewGuide,
      accountLabelService,
      customerService,
    ...
    gaapiResources: [
      accountManagementGuide,
      customerServiceRef,
      customerLabelServiceRef,
      labelServiceRef,
      customerFieldRef,
      customerLabelFieldRef,
      labelFieldRef,
    ],
  },
  'campaigns': {
    awapiResources: [
      campaignsOverviewGuide,
      shoppingGuide,
      mobileAppCampaignsGuide,
      labelsGuide,
      bidLandscapesGuide,
      campaignService,
      campaignFeedService,
    ...
    gaapiResources: [
      gaapiCampaignsOverviewGuide,
      campaignsCreateCampaignsGuide,
      appCampaignsGuide,
      conceptsOverviewGuide,
      conceptsChangingObjectsGuide,
      conceptsRetrievingObjectsGuide,
      conceptsFieldServiceGuide,
      reportingOverviewGuide,
      queryOverviewGuide,
      campaignServiceRef,
      campaignBudgetServiceRef,
      campaignFeedServiceRef,
      shoppingPerformanceViewServiceRef,
      campaignLabelServiceRef,
      labelServiceRef,
      domainCategoryServiceRef,
      mobileAppCategoryConstantServiceRef,
      mobileDeviceConstantServiceRef,
      campaignFieldRef,
      adNetworkTypeFieldRef,
      campaignBudgetFieldRef,
      campaignFeedFieldRef,
      shoppingPerformanceViewFieldRef,
      campaignLabelFieldRef,
      labelFieldRef,
      domainCategoryFieldRef,
      mobileAppCategoryConstantFieldRef,
      mobileDeviceConstantFieldRef,
    ],
  },
  'adgroups': {
    awapiResources: [
    ...
    gaapiResources: [
      ...
      queryOverviewGuide,
      adGroupServiceRef,
      adGroupFeedServiceRef,
      adGroupLabelServiceRef,
      adGroupAudienceViewServiceRef,
      labelServiceRef,
      adGroupFieldRef,
      adGroupFeedFieldRef,
      adGroupLabelFieldRef,
      adGroupAudienceViewFieldRef,
      labelFieldRef,
    ],
  },
  'productgroups': {
    ...
    gaapiResources: [
      shoppingAdsOverviewGuide,
      shoppingAdsReportingGuide,
      targetingOverviewGuide,
      targetingCriteriaGuide,
      conceptsOverviewGuide,
      conceptsChangingObjectsGuide,
      conceptsOverviewGuide,
      conceptsChangingObjectsGuide,
      ...
      queryOverviewGuide,
      shoppingPerformanceViewServiceRef,
      adGroupCriterionServiceRef,
      productGroupViewServiceRef,
      productBiddingCategoryConstantServiceRef,
      adGroupCriterionLabelServiceRef,
      shoppingPerformanceViewFieldRef,
      productGroupViewFieldRef,
      productBiddingCategoryConstantFieldRef,
      adGroupCriterionFieldRef,
      adGroupCriterionLabelFieldRef,
    ],
  },
  'hotelgroups': {
    awapiResources: [],
    gaapiResources: [
      hotelAdsOverviewGuide,
      hotelAdsReportingGuide,
      targetingOverviewGuide,
      targetingCriteriaGuide,
      hotelGroupViewServiceRef,
      hotelPerformanceViewServiceRef,
      adGroupBidModifierServiceRef,
      adGroupCriterionServiceRef,
      hotelGroupViewFieldRef,
      hotelPerformanceViewFieldRef,
      hotelBookingWindowDaysFieldRef,
      hotelCenterIdFieldRef,
      hotelCheckInDateFieldRef,
      hotelCheckInDayOfWeekFieldRef,
      hotelClassFieldRef,
      hotelCityFieldRef,
      hotelCountryFieldRef,
      hotelDateSelectionTypeFieldRef,
      hotelLengthOfStayFieldRef,
      hotelStateFieldRef,
      partnerHotelIdFieldRef,
      adGroupBidModifierFieldRef,
      adGroupCriterionFieldRef,
    ],
  },
  'ads': {
    awapiResources: [
      adFeaturesGuide,
      expandedTextAdsGuide,
      responsiveAdsGuide,
      templateAdsGuide,
      dynamicSearchAdsGuide,
      dynamicRemarketingGuide,
      exemptionRequestsGuide,
      clickTrackingGuide,
      adGroupAdService,
      adService,
      adParamService,
    ...
    gaapiResources: [
      ...
      queryOverviewGuide,
      adGroupAdServiceRef,
      adParameterServiceRef,
      adGroupAdLabelServiceRef,
      dynamicSearchAdsSearchTermViewServiceRef,
      assetServiceRef,
      mediaFileServiceRef,
      adGroupAdFieldRef,
      adParameterFieldRef,
      adGroupAdLabelFieldRef,
      dynamicSearchAdsSearchTermViewFieldRef,
      assetFieldRef,
      mediaFileFieldRef,
      slotFieldRef,
    ],
  ...
  'adextensions': {
    awapiResources: [
      extensionSettingsGuide,
      structuredSnippetsGuide,
      feedServicesGuide,
      feedServicesLocationsGuide,
      adCustomizersGuide,
    ...
    gaapiResources: [
      feedPlaceholderViewServiceRef,
      extensionFeedItemServiceRef,
      customerExtensionSettingServiceRef,
      campaignExtensionSettingServiceRef,
      adGroupExtensionSettingServiceRef,
      feedServiceRef,
      feedItemServiceRef,
      feedItemTargetServiceRef,
      feedMappingServiceRef,
      locationViewServiceRef,
      feedPlaceholderViewFieldRef,
      extensionFeedItemFieldRef,
      customerExtensionSettingFieldRef,
      campaignExtensionSettingFieldRef,
      adGroupExtensionSettingFieldRef,
      feedFieldRef,
      feedItemFieldRef,
      feedItemTargetFieldRef,
      feedMappingFieldRef,
      placeholderTypeFieldRef,
      locationViewFieldRef,
    ],
  },
  'videos': {
    awapiResources: [campaignsOverviewGuide, videoPerformanceReport],
    gaapiResources: [
      conceptsOverviewGuide,
      conceptsChangingObjectsGuide,
      conceptsRetrievingObjectsGuide,
  ...
  'landingpages': {
    ...
    gaapiResources: [
      ...
      reportingOverviewGuide,
      queryOverviewGuide,
      landingPageViewServiceRef,
      expandedLandingPageViewServiceRef,
      dynamicSearchAdsSearchTermViewServiceRef,
      landingPageViewFieldRef,
      expandedLandingPageViewFieldRef,
      dynamicSearchAdsSearchTermViewFieldRef,
    ],
  },
  'keywords': {
  ...
  'keywords/display': {
    ...
    gaapiResources: [
      reportingOverviewGuide,
      queryOverviewGuide,
      displayKeywordViewServiceRef,
      adGroupCriterionServiceRef,
      adGroupCriterionLabelServiceRef,
      displayKeywordViewFieldRef,
      adGroupCriterionFieldRef,
      adGroupCriterionLabelFieldRef,
    ],
  },
  'keywords/negative': {
    awapiResources: [
      objectsMethodsGuide,
      targetingTypesGuide,
      negativeKeywordsSharedSetsGuide,
      adGroupCriterionService,
    ...
    gaapiResources: [
      ...
      adGroupCriterionServiceRef,
      adGroupCriterionLabelServiceRef,
      campaignSharedSetServiceRef,
      sharedSetServiceRef,
      sharedCriterionServiceRef,
      customerNegativeCriterionServiceRef,
      keywordViewFieldRef,
      adGroupCriterionFieldRef,
      adGroupCriterionLabelFieldRef,
      campaignSharedSetFieldRef,
      sharedSetFieldRef,
      sharedCriterionFieldRef,
      customerNegativeCriterionFieldRef,
    ],
  },
  'keywords/searchterms': {
    ...
    gaapiResources: [
      paidOrganicSearchTermViewServiceRef,
      searchTermViewServiceRef,
      paidOrganicSearchTermViewFieldRef,
      searchTermViewFieldRef,
      searchTermMatchTypeFieldRef,
      searchEngineResultsPageTypeFieldRef,
    ],
  },
  'dynamicadtargets': {
    awapiResources: [
  ...
  'audiences': {
    ...
    gaapiResources: [
      ...
      reportingOverviewGuide,
      queryOverviewGuide,
      campaignAudienceViewServiceRef,
      remarketingActionServiceRef,
      campaignCriterionServiceRef,
      adGroupAudienceViewServiceRef,
      adGroupCriterionServiceRef,
      adGroupCriterionLabelServiceRef,
      userInterestServiceRef,
      userListServiceRef,
      customInterestServiceRef,
      campaignAudienceViewFieldRef,
      remarketingActionFieldRef,
      campaignCriterionFieldRef,
      adGroupAudienceViewFieldRef,
      adGroupCriterionFieldRef,
      adGroupCriterionLabelFieldRef,
      userInterestFieldRef,
      userListFieldRef,
      customInterestFieldRef,
    ],
  },
  'demographics': {
    awapiResources: [
    ...
    gaapiResources: [
      ...
      reportingOverviewGuide,
      queryOverviewGuide,
      ageRangeViewServiceRef,
      adGroupCriterionServiceRef,
      ageRangeViewFieldRef,
      adGroupCriterionFieldRef,
    ],
  },
  'demographics/gender': {
  ...
  'demographics/parental': {
    ...
    gaapiResources: [
      reportingOverviewGuide,
      queryOverviewGuide,
      parentalStatusViewServiceRef,
      adGroupCriterionServiceRef,
      parentalStatusViewFieldRef,
      adGroupCriterionFieldRef,
    ],
  },
  'demographics/income': {
    awapiResources: [targetingTypesGuide, adGroupCriterionService],
    gaapiResources: [
      targetingOverviewGuide,
      adGroupCriterionServiceRef,
      adGroupCriterionFieldRef,
  ...
  'topics': {
    ...
    gaapiResources: [
      ...
      queryOverviewGuide,
      topicViewServiceRef,
      topicConstantServiceRef,
      adGroupCriterionServiceRef,
      topicViewFieldRef,
      topicConstantFieldRef,
      adGroupCriterionFieldRef,
    ],
  },
  'topics/exclusions': {
  ...
  'placements': {
    ...
    gaapiResources: [
      ...
      reportingOverviewGuide,
      queryOverviewGuide,
      detailPlacementViewServiceRef,
      groupPlacementViewServiceRef,
      detailPlacementViewFieldRef,
      groupPlacementViewFieldRef,
    ],
  },
  'placements/managed': {
    awapiResources: [
    ...
    gaapiResources: [
      reportingOverviewGuide,
      queryOverviewGuide,
      managedPlacementViewServiceRef,
      adGroupCriterionServiceRef,
      managedPlacementViewFieldRef,
      adGroupCriterionFieldRef,
    ],
  },
  ...
  'settings/adgroups': {
    awapiResources: [
      ...
      adGroupService,
      adGroupSettings,
      adGroupContentBidCriterionTypeGroup,
      adGroupType,
  ...
  'settings/campaign': {
    awapiResources: [
      ...
      campaignSettings,
      campaignBudget,
      campaignBiddingStrategyConfiguration,
      campaignNetworkSetting,
    ...
    gaapiResources: [
      targetingOverviewGuide,
      targetingLocationTargetingGuide,
      targetingBidModifiersGuide,
      conceptsOverviewGuide,
      conceptsChangingObjectsGuide,
      conceptsRetrievingObjectsGuide,
      ...
      queryOverviewGuide,
      campaignServiceRef,
      biddingStrategyServiceRef,
      campaignBudgetServiceRef,
      campaignBidModifierServiceRef,
      languageConstantServiceRef,
      locationViewServiceRef,
      campaignFieldRef,
      biddingStrategyFieldRef,
      campaignBudgetFieldRef,
      campaignBidModifierFieldRef,
      languageConstantFieldRef,
      locationViewFieldRef,
    ],
  },
  'settings/campaign/display': {
    awapiResources: [
      biddingGuide,
      budgetsGuide,
      campaignService,
    ...
    gaapiResources: [
      ...
      campaignBudgetServiceRef,
      campaignBidModifierServiceRef,
      carrierConstantServiceRef,
      languageConstantServiceRef,
      operatingSystemVersionConstantServiceRef,
      campaignFieldRef,
      biddingStrategyFieldRef,
      campaignBudgetFieldRef,
      campaignBidModifierFieldRef,
      carrierConstantFieldRef,
      deviceFieldRef,
      languageConstantFieldRef,
      operatingSystemVersionConstantFieldRef,
    ],
  },
  'settings/account': {
    awapiResources: [
    ...
    gaapiResources: [
      ...
      reportingOverviewGuide,
      queryOverviewGuide,
      customerClientServiceRef,
      customerClientLinkServiceRef,
      customerManagerLinkServiceRef,
      customerServiceRef,
      conversionActionServiceRef,
      customerClientFieldRef,
      customerClientLinkFieldRef,
      customerManagerLinkFieldRef,
      customerFieldRef,
      conversionActionFieldRef,
    ],
  },
  'locations': {
    awapiResources: [
      locationTargetingGuide,
      geotargetingGuide,
      campaignCriterionService,
    ...
    gaapiResources: [
      ...
      locationViewServiceRef,
      campaignCriterionServiceRef,
      geographicViewServiceRef,
      geoTargetConstantServiceRef,
      clickViewServiceRef,
      locationViewFieldRef,
      campaignCriterionFieldRef,
      geographicViewFieldRef,
      geoTargetConstantFieldRef,
      clickViewFieldRef,
      geoTargetCountyFieldRef,
      geoTargetDistrictFieldRef,
      geoTargetMostSpecificLocationFieldRef,
      geoTargetPostalCodeFieldRef,
      geoTargetStateFieldRef,
    ],
  },
  'locations/negative': {
    awapiResources: [
  ...
  'locations/geographicreport': {
    awapiResources: [geoPerformanceReport],
    gaapiResources: [
      geographicViewServiceRef,
      geoTargetConstantServiceRef,
      clickViewServiceRef,
  ...
  'adschedule': {
    ...
    gaapiResources: [
      ...
      reportingOverviewGuide,
      queryOverviewGuide,
      adScheduleViewServiceRef,
      adScheduleViewFieldRef,
    ],
  },
  'devices': {
    awapiResources: [
  ...
  'advancedbidadj': {
    awapiResources: [campaignBidModifierService, callMetricsCallDetailsReport],
    gaapiResources: [campaignBidModifierServiceRef],
  },
  'advancedbidadj/topcontent': {
    awapiResources: [adGroupBidModifierService, topContentPerformanceReport],
    gaapiResources: [adGroupBidModifierServiceRef],
  },
  'changehistory': {
    awapiResources: [customerSyncService],
    gaapiResources: [
      changeStatusGuide,
      changeStatusServiceRef,
      changeStatusFieldRef,
    ],
  },
  'drafts': {
    awapiResources: [
      campaignDraftsExperimentsGuide,
      draftService,
  ...
  'advariations': {
    awapiResources:
        [expandedTextAdsGuide, adGroupAdService, adPerformanceReport],
    gaapiResources: [
      conceptsOverviewGuide,
      conceptsChangingObjectsGuide,
      conceptsRetrievingObjectsGuide,
  ...
  'keywordplanner': {
    awapiResources: [
      targetingIdeaServiceGuide,
      geotargetingGuide,
      trafficEstimatorServiceGuide,
    ...
    gaapiResources: [
      ...
      conceptsRetrievingObjectsGuide,
      conceptsFieldServiceGuide,
      keywordPlanningReleaseNotes,
      reportingOverviewGuide,
      queryOverviewGuide,
      keywordPlanServiceRef,
      keywordPlanAdGroupServiceRef,
      keywordPlanCampaignServiceRef,
      keywordPlanKeywordServiceRef,
      keywordPlanNegativeKeywordServiceRef,
      keywordPlanIdeaServiceRef,
      campaignCriterionSimulationServiceRef,
      adGroupSimulationServiceRef,
      adGroupCriterionSimulationServiceRef,
      keywordPlanFieldRef,
      keywordPlanAdGroupFieldRef,
      keywordPlanCampaignFieldRef,
      keywordPlanKeywordFieldRef,
      keywordPlanNegativeKeywordFieldRef,
      campaignCriterionSimulationFieldRef,
      adGroupSimulationFieldRef,
      adGroupCriterionSimulationFieldRef,
    ],
  },
  'sharedbudgets': {
    awapiResources: [budgetsGuide, budgetService, budgetPerformanceReport],
    gaapiResources: [
      conceptsOverviewGuide,
      conceptsChangingObjectsGuide,
      conceptsRetrievingObjectsGuide,
  ...
  'bidstrategies': {
    awapiResources:
        [biddingGuide, biddingStrategyService, bidGoalPerformanceReport],
    gaapiResources: [
      conceptsOverviewGuide,
      conceptsChangingObjectsGuide,
      conceptsRetrievingObjectsGuide,
  ...
  'campaigngroups': {
    awapiResources: [
      ...
      campaignGroupPerformanceReport,
    ],
    gaapiResources: [
      conceptsOverviewGuide,
      conceptsChangingObjectsGuide,
  ...
  'conversions': {
    ...
    gaapiResources: [
      ...
      queryOverviewGuide,
      conversionActionServiceRef,
      conversionUploadServiceRef,
      conversionAdjustmentUploadServiceRef,
      clickViewServiceRef,
      conversionActionFieldRef,
      clickViewFieldRef,
    ],
  ...
  'billing': {
    awapiResources: [budgetOrderGuide, budgetOrderService],
    gaapiResources: [
      billingOverviewGuide,
      billingAccountBudgetsGuide,
      billingBillingSetupsGuide,
      billingSetupServiceRef,
      accountBudgetServiceRef,
      accountBudgetProposalServiceRef,
      paymentsAccountServiceRef,
      billingSetupFieldRef,
      accountBudgetFieldRef,
      accountBudgetProposalFieldRef,
    ],
  },
  'businessdata/feed': {
    awapiResources: [
  ...
  'reporting': {
    awapiResources: [
      reportingGuide,
      uireportsGuide,
      zeroimpressionStructureReportsGuide,
      awqlGuide,
    ...
    gaapiResources: [
      ...
      conceptsFieldServiceGuide,
      reportingOverviewGuide,
      reportingExampleGuide,
      reportingCriteriaMetricsGuide,
      reportingZeroImpressionsGuide,
      queryOverviewGuide,
      googleAdsServiceRef,
      googleAdsFieldServiceRef,
      metricsFieldRef,
...
//ads/devrel/adwords/shimesu/utils.js
goog.loadModule(function(exports) {'use strict';goog.module('ads.devrel.adwords.shimesu.utils');

const dom = goog.require('goog.dom');
const safe = goog.require('goog.dom.safe');
const {ResourceCategory, Resource, urlPathsToResources} = goog.require('ads.devrel.adwords.shimesu.resources');

const AWAPI_DEVSITE_RESOURCE_PREFIX =
    'https://developers.google.com/adwords/api/docs';
const GAAPI_DEVSITE_RESOURCE_PREFIX =
    'https://developers.google.com/google-ads/api';
const GAAPI_DEVSITE_DOC_PREFIX = '/docs';
const GAAPI_DEVSITE_REFERENCE_PREFIX = '/reference';
const GAAPI_DEVSITE_FIELD_PREFIX = '/fields/latest';

/**
 * Updates the content of the tab of specified product name using the
 * pre-defined resources, based on the current opened web page.
 *
 * @param {!Array<!Resource>} resourcesList An array of resources to
 *     be populated on the content
 * @param {string} productName A product name to update its content
 */
function updateProductTabContent(resourcesList, productName) {
  const categoriesToContentChildren = {};
  for (const categoryName in ResourceCategory) {
    categoriesToContentChildren[ResourceCategory[categoryName]] =
        document.createElement('ul');
  }

  // Add resources as a child node of the div content of each category
  // (guide, service, report).
  for (const resource of resourcesList) {
    const resourceLink = dom.createElement(dom.TagName.A);
    let prefix = (productName === 'awapi') ? AWAPI_DEVSITE_RESOURCE_PREFIX :
                                             GAAPI_DEVSITE_RESOURCE_PREFIX;
    if (productName === 'gaapi') {
      switch (resource.category) {
        case ResourceCategory.GUIDE:
          prefix += GAAPI_DEVSITE_DOC_PREFIX;
          break;
        case ResourceCategory.SERVICE:
          prefix += GAAPI_DEVSITE_REFERENCE_PREFIX;
          break;
        case ResourceCategory.FIELD:
          prefix += GAAPI_DEVSITE_FIELD_PREFIX;
          break;
      }
    }
    safe.setAnchorHref(resourceLink, prefix + resource.urlPath);
    resourceLink.textContent = resource.name;

    const liTag = document.createElement('li');
    liTag.appendChild(resourceLink);

    categoriesToContentChildren[resource.category].appendChild(liTag);
  }

  // Update the product's div content of each category.
  for (const categoryName in ResourceCategory) {
    const resourceCategoryContentTab = document.querySelector(`#${
        productName}-content > #${ResourceCategory[categoryName]}s-content`);
    if (resourceCategoryContentTab) {
      resourceCategoryContentTab.textContent = '';
      // Add N/A for the categories that have no relevant resources.
      if (!categoriesToContentChildren[ResourceCategory[categoryName]]
               .childElementCount) {
        const notApplicableNode = document.createElement('p');
        notApplicableNode.textContent = 'N/A';
        notApplicableNode.classList.add('not-applicable');
        resourceCategoryContentTab.appendChild(notApplicableNode);
      } else {
        resourceCategoryContentTab.appendChild(
            categoriesToContentChildren[ResourceCategory[categoryName]]);
      }
    }
  }
...
/**
 * Populates all contents in all tabs.
 *
 * @param {!Array<!Tab>} tabs All available Chrome tabs
 * @param {?Object.<string,!Object>=} resourcesMap associative array from
 *     URL paths to resources.
 */
function populateAllTabContents(tabs, resourcesMap = urlPathsToResources) {
  const current = tabs[0];

  if (current.status !== 'complete') {
    alert(
        'The web page has not been fully loaded yet. Please try again later.');
    return;
  }

  const url = new URL(current.url);

  // Look up the path-to-resource map by using the full paths after trailing
  // the "/aw/" prefix first. If not found, continue shortening the path by
  // removing each token (delimited by "/") from right to left.
  let candidatePathName = url.pathname.substr('/aw/'.length);
  const splitPathNames = candidatePathName.split('/');
  while (!(candidatePathName in resourcesMap) && splitPathNames.length > 0) {
    splitPathNames.pop();
    candidatePathName = splitPathNames.join('/');
  }

  const tabsWithResources = resourcesMap[candidatePathName];
  if (tabsWithResources) {
    updateProductTabContent(tabsWithResources.awapiResources, 'awapi');
    updateProductTabContent(tabsWithResources.gaapiResources, 'gaapi');
  }
}

/**
 * Shows the content of the specified product name.
 *
 * @param {string} productName A product name to open its tab
 */
function openTab(productName) {
  // Hide all tabs.
  ...
  // Shows only the tab of specified product.
  document.getElementById(`${productName}-content`).style.display = 'block';
  document.getElementById(`${productName}-tab`).classList.add('active');
}

exports = {
  updateProductTabContent,
  populateAllTabContents,
  openTab,
};

;return exports;});

//ads/devrel/adwords/shimesu/popup.js
goog.loadModule(function(exports) {'use strict';goog.module('ads.devrel.adwords.shimesu.popup');

const {populateAllTabContents, openTab} = goog.require('ads.devrel.adwords.shimesu.utils');

/**
 * Initialization process to open the default tab and add necessary event
 * listeners.
 */
function init() {
  // Open the Google Ads API tab by default.
  document.getElementById('awapi-tab').style.display = 'block';
  document.getElementById('awapi-content').classList.add('active');
  openTab('awapi');

  document.getElementById('awapi-tab').addEventListener('click', () => {
    openTab('awapi');
  });
  document.getElementById('gaapi-tab').addEventListener('click', () => {
    openTab('gaapi');
  });

  // Open a new tab in Chrome when any link inside the pop-up is clicked.
  goog.global.addEventListener('click', (event) => {
    if (event.target.href) {
      chrome.tabs.create({url: event.target.href});
    }
  });

  // Populate all contents for the active tab.
  document.addEventListener('DOMContentLoaded', () => {
    chrome.tabs.query(
        {active: true, currentWindow: true}, populateAllTabContents);
  });
}
