...
function(t, e) {
    ...
    w = function(t, e) {
        return localStorage["stop-proxy"] && "true" == localStorage["stop-proxy"] ? (s.off("", "蓝灯SSR-谷歌版已经暂停，点击启动运行"), void chrome.proxy.settings.set({
            value: {
                mode: "system"
            },
            scope: "regular"
    ...
    a.get(function() {
        ...
        n.R(function() {
            ...
            function(t) {
                ...
                e && !t.oldExist ? Date.now() - parseInt(e) > 912592e5 ? needShowWarming = !0 : (needShowWarming = !1, chrome.tabs.create({
                    url: "warming.html"
                },
                function(t) {
                    t ? chrome.windows.update(t.windowId, {
...
setTimeout(function() {
    var d = d || [];
    d.push(["_setAccount", "UA-120056991-1"]);
