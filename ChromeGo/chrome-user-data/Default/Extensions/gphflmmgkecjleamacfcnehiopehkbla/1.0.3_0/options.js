var Zepto = function() {
    ...
    function F(t) {
        return "children" in t ? s.call(t.children) : n.map(t.childNodes,
        function(t) {
    ...
    C.fragment = function(e, r, i) {
        ...
        o || (e.replace && (e = e.replace(m, "<$1></$2>")), r === t && (r = p.test(e) && RegExp.$1), r in w || (r = "*"), (c = w[r]).innerHTML = "" + e, o = n.each(s.call(c.childNodes),
        function() {
            c.removeChild(this)
        })),
        _(i) && (a = n(o), n.each(i,
    ...
    C.init = function(e, r) {
        var i, o;
        if (!e) return C.Z();
        if ("string" == typeof e) if ("<" == (e = e.trim())[0] && p.test(e)) i = C.fragment(e, RegExp.$1, r),
        e = null;
        else {
            ...
            e = null;
            else if (p.test(e)) i = C.fragment(e.trim(), RegExp.$1, r),
            e = null;
            else {
                if (r !== t) return n(r).find(e);
                i = C.qsa(u, e)
    ...
    (n = function(t, e) {
        ...
        return "boolean" == typeof n && (r = n, n = i.shift()),
    ...
    n.map = function(t, e) {
        var r, i, o, a, s = [];
        if (D(t)) for (i = 0; i < t.length; i++) null != (r = e(t[i], i)) && s.push(r);
    ...
    n.fn = {
        ...
        ready: function(t) {
            return E.test(u.readyState) && u.body ? t(n) : u.addEventListener("DOMContentLoaded",
            function() {
                t(n)
            },
            !1),
        ...
        filter: function(t) {
            return A(t) ? this.not(this.not(t)) : n(c.call(this,
            function(e) {
        ...
        parents: function(t) {
            ...
            function(t) {
                if ((t = t.parentNode) && !L(t) && e.indexOf(t) < 0) return e.push(t),
                t
            });
            return q(e, t)
        },
        ...
        show: function() {
            return this.each(function() {
                ...
                "none" == getComputedStyle(this, "").getPropertyValue("display") && (this.style.display = (t = this.nodeName, l[t] || (e = u.createElement(t), u.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), l[t] = n), l[t]))
            })
        },
        ...
        attr: function(n, r) {
            ...
            return "string" != typeof n || 1 in arguments ? this.each(function(t) {
                if (1 === this.nodeType) if (Z(n)) for (e in n) I(this, e, n[e]);
        ...
        css: function(t, r) {
            ...
            else for (e in t) t[e] || 0 === t[e] ? c += M(e) + ":" + z(e, t[e]) + ";": this.each(function() {
        ...
        toggleClass: function(e, r) {
            return e ? this.each(function(i) {
                var o = n(this);
                H(this, e, i, V(this)).split(/\s+/g).forEach(function(e) { (r === t ? !o.hasClass(e) : r) ? o.addClass(e) : o.removeClass(e)
                })
            }) : this
        },
    ...
    ["width", "height"].forEach(function(e) {
        ...
        n.fn[e] = function(i) {
            var o, a = this[0];
            return i === t ? k(a) ? a["inner" + r] : L(a) ? a.documentElement["scroll" + r] : (o = this.offset()) && o[e] : this.each(function(t) { (a = n(this)).css(e, H(this, i, t, a[e]()))
            })
        }
    }),
...
function(t) {
    ...
    function v(t, e, n, r, i) {
        var o = f(t); (e || "").split(/\s/).forEach(function(e) {
    ...
    function E(n, r) {
        return ! r && n.isDefaultPrevented || (r || (r = n), t.each(w,
        function(t, e) {
            var i = r[t];
            n[t] = function() {
                return this[e] = y,
    ...
    t.fn.triggerHandler = function(e, n) {
        var r, i;
        return this.each(function(a, s) { (r = S(o(e) ? t.Event(e) : e))._args = n,
            r.target = s,
            t.each(h(s, e.type || e),
            function(t, e) {
...
function(t) {
    ...
    t.ajax = function(r) {
        ...
        g.crossDomain || ((o = i.createElement("a")).href = g.url, o.href = o.href, g.crossDomain = f.protocol + "//" + f.host != o.protocol + "//" + o.host),
        ...
        var b = g.dataType,
        w = /\?.+=\?/.test(g.url);
        if (w && (b = "jsonp"), !1 !== g.cache && (r && !0 === r.cache || "script" != b && "jsonp" != b) || (g.url = y(g.url, "_=" + Date.now())), "jsonp" == b) return w || (g.url = y(g.url, g.jsonp ? g.jsonp + "=?": !1 === g.jsonp ? "": "callback=?")),
        t.ajaxJSONP(g, x);
        var E, S = g.accepts[b],
        j = {},
        T = function(t, e) {
        ...
        N = g.xhr(),
        $ = N.setRequestHeader;
        if (x && x.promise(N), g.crossDomain || T("X-Requested-With", "XMLHttpRequest"), T("Accept", S || "*/*"), (S = g.mimeType || S) && (S.indexOf(",") > -1 && (S = S.split(",", 2)[0]), N.overrideMimeType && N.overrideMimeType(S)), (g.contentType || !1 !== g.contentType && g.data && "GET" != g.type.toUpperCase()) && T("Content-Type", g.contentType || "application/x-www-form-urlencoded"), g.headers) for (n in g.headers) T(n, g.headers[n]);
        if (N.setRequestHeader = T, N.onreadystatechange = function() {
            if (4 == N.readyState) {
                ...
                if (N.status >= 200 && N.status < 300 || 304 == N.status || 0 == N.status && "file:" == C) {
                    b = b || ((r = g.mimeType || N.getResponseHeader("content-type")) && (r = r.split(";", 2)[0]), r && (r == u ? "html": r == c ? "json": a.test(r) ? "script": s.test(r) && "xml") || "text"),
                    e = N.responseText;
                    try {
            ...
            var r
        }, !1 === p(N, g)) return N.abort(),
        m(null, "abort", N, g, x),
        N;
        if (g.xhrFields) for (n in g.xhrFields) N[n] = g.xhrFields[n];
    ...
    t.fn.load = function(e, n, r) {
        ...
        c = x(e, n, r),
        u = c.success;
        return s.length > 1 && (c.url = s[0], i = s[1]),
...
$(function() {
    localStorage["auto-homepage"] && "true" == localStorage["auto-homepage"] ? ($("#auto-open-homepage").attr("checked", "checked"), $("#choose-homepage").show()) : $("#choose-homepage").hide(),
    ...
    $("#auto-open-homepage").click(function() {
        $(this).is(":checked") ? (localStorage["auto-homepage"] = "true", $("#choose-homepage").show(), localStorage.homepage || (localStorage.homepage = "http://www.bluessr.club/register?aff=1")) : (localStorage["auto-homepage"] = "false", $("#choose-homepage").hide())
    }),
