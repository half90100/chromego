...
document.getElementById("refreshP").addEventListener("click",
function(e) {
...
document.getElementById("restartP").addEventListener("click",
function(e) {
...
document.getElementById("startP").addEventListener("click",
function(e) {
    chrome.runtime.sendMessage({
        reqtype: "start"
    },
